            ...
            <main class="col-md-9">
                ...
                <header class="mb-3">
                    <div class="form-inline">
                        ...
                        <div class="btn-group">
                            <a href="{{ url('catalog-grid') }}" class="btn btn-light" data-toggle="tooltip" title="List view"> 
                                <i class="fa fa-bars"></i></a>
                            <a href="{{ url('catalog-list') }}" class="btn btn-light active" data-toggle="tooltip" title="Grid view"> 
                ...
                <article class="card card-product-list">
                    <div class="row no-gutters">
                        <aside class="col-md-3">
                            <a href="{{ url('/products') }}" class="img-wrap">
                        ...
                        <aside class="col-sm-3">
                            <div class="info-aside">
                                ...
                                <p class="mt-3">
                                    <a href="#" class="btn btn-outline-primary"> <i class="fa fa-envelope"></i></a>
