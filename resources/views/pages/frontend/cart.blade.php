                    ...
                    <table class="table table-borderless table-shopping-cart">
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <figure class="itemside">
                                        <div class="aside"><img src="{{ asset('frontend/images/items/1.jpg') }}" class="img-sm"></div>
                                ...
                                <td class="text-right"> 
                                    ...
                                    <a href="#" class="btn btn-danger btn-round"> <i class="fa fa-trash"></i></a>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <figure class="itemside">
                                        <div class="aside"><img src="{{ asset('frontend/images/items/2.jpg') }}" class="img-sm"></div>
                                        <figcaption class="info">
                            ...
                            <tr>
                                <td>
                                    <figure class="itemside">
                                        <div class="aside"><img src="{{ asset('frontend/images/items/3.jpg') }}" class="img-sm"></div>
                                        <figcaption class="info">
