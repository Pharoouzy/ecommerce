        ...
        <div class="row">
                ...
                <div class="card">
                    <article class="gallery-wrap"> 
                        <div class="img-big-wrap">
                            <div> <a href="#"><img src="{{ asset('frontend/images/items/15.jpg') }}"></a></div>
                        </div> <!-- slider-product.// -->
                        <div class="thumbs-wrap">
                            <a href="#" class="item-thumb"> <img src="{{ asset('frontend/images/items/15.jpg') }}"></a>
                            <a href="#" class="item-thumb"> <img src="{{ asset('frontend/images/items/15-1.jpg') }}"></a>
                            <a href="#" class="item-thumb"> <img src="{{ asset('frontend/images/items/15-2.jpg') }}"></a>
                            <a href="#" class="item-thumb"> <img src="{{ asset('frontend/images/items/15-1.jpg') }}"></a>
                        </div> <!-- slider-nav.// -->
            ...
            <main class="col-md-6">
                <article class="product-info-aside">
                    ...
                    <div class="mb-3"> 
                        <var class="price h4">NGN 465,00</var> 
                        <span class="text-muted">NGN 562.65 incl. VAT</span> 
        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <table class="table table-bordered">
                    ...
                    <tr>
                        <td>Type of energy</td><td>Lava stone</td>
                    </tr>
                    <tr>
                        <td>Number of zones</td><td>2</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td>Width</td><td>500mm</td>
                    </tr>
                    <tr>
                        <td>Depth</td><td>400mm</td>
                    </tr>
                    <tr>
                        <td>Height	</td><td>700mm</td>
                    </tr>
                    <tr>
                        <th colspan="2">Materials</th>
                    </tr>
                    <tr>
                        <td>Exterior</td><td>Stainless steel</td>
                    </tr>
                    <tr>
                        <td>Interior</td><td>Iron</td>
                    </tr>
                    <tr>
                        <th colspan="2">Connections</th>
                    </tr>
                    <tr>
                        <td>Heating Type</td><td>Gas</td>
                    </tr>
                    <tr>
                        <td>Connected load gas</td><td>15 Kw</td>
                    </tr>
                </table>
            </div> <!-- col.// -->
            ...
            <aside class="col-md-4">
                <div class="box">
                    ...
                    <article class="media mb-3">
                        <a href="#"><img class="img-sm mr-3" src="{{ asset('frontend/images/posts/3.jpg') }}"></a>
                    ...
                    <article class="media mb-3">
                        <a href="#"><img class="img-sm mr-3" src="{{ asset('frontend/images/posts/2.jpg') }}"></a>
                        <div class="media-body">
                    ...
                    <article class="media mb-3">
                        <a href="#"><img class="img-sm mr-3" src="{{ asset('frontend/images/posts/1.jpg') }}"></a>
                        <div class="media-body">
                            <h6 class="mt-0"><a href="#">New tips and tricks</a></h6>
                            <p class="mb-2"> Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin </p>
                        </div>
