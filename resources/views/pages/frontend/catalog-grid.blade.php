    ...
    <div class="container"> 
        ...
        <header class="mb-3">
            <div class="form-inline">
                ...
                <div class="btn-group">
                    <a href="{{ url('catalog-grid') }}" class="btn btn-light active" data-toggle="tooltip" title="List view"> 
                        <i class="fa fa-bars"></i></a>
                    <a href="{{ url('catalog-list') }}" class="btn btn-light" data-toggle="tooltip" title="Grid view"> 
        ...
        <div class="row">
            <div class="col-md-3">
                <figure class="card card-product-grid">
                    ...
                    <figcaption class="info-wrap">
                        <a href="{{ url('/product') }}" class="title mb-2">Hot sale unisex New Design Shirt for sport polo shirts latest design</a>
                        ...
                        <a href="#" class="btn btn-outline-primary"> <i class="fa fa-envelope"></i> Contact </a>
            ...
            <div class="col-md-3">
                <figure class="card card-product-grid">
                    <div class="img-wrap"> 
                        <img src="{{ asset('frontend/images/items/15.jp') }}g">
                    </div> <!-- img-wrap.// -->
                    <figcaption class="info-wrap">
                        <a href="#" class="title mb-2">Cheap and Best demo clothe with latest Fashion styles for Men</a>
                        <div class="price-wrap">
